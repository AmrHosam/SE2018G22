...
/*if($resultCheck >0)
{
	...
	{    
		$array['student id']= $row['student id'];
	    $array['full name']= $row['full name'];
		$array['year']= $row['year'];
		$array['division']= $row['division'];
		$array['email']= $row['email'];	
	}
}
/*while ($trialdata=mysqli_fetch_assoc($results){
	echo <label>trialdata['fullname']<label>;
	echo <label>trialdata['studentID']<label>;
	echo <label>trialdata['year']<label>;
	echo <label>trialdata['division']<label>;
	echo <label>trialdata['email']<label>;
echo <label>trialdata['phone']<label>;*/}
