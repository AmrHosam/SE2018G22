		     ...
		     <div class="row form-group">
			     <div class="col-xs-4">
                   ...
                   <select> \\Electrical divisions
                    ...
                    <div class="col-sm-12">
     <button style="cursor: pointer; display: block; margin: auto; margin-top: 20px; border-radius: 10px; border-color:#800000;background-color: transparent;width: 95px; height: 45px;color: black; font-weight: 500;font-size: 22px;" type="submit">Submit</button>
		  </div>
                 </form>
</div>
</div>
